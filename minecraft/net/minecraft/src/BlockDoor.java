...
public class BlockDoor extends Block
{
    protected BlockDoor(int par1, Material par2Material)
    {
        ...
        else if (par2Material == Material.gold)
        {
    ...
    {
        if (blockMaterial == Material.iron || blockMaterial == Material.gold)
        {
            return true;
        }
        else
    ...
    public int idDropped(int par1, Random par2Random, int par3)
    {
        ...
        else if (blockMaterial == Material.gold)
        {
            return Item.goldenDoor.shiftedIndex;
        }
        else
        {
