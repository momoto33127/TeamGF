...
public class Block
{
    ...
    /** AJOUT DES BLOCKS MOD **/

    public static final BlockHalfSlab clothSlab1;
    public static final BlockHalfSlab clothSlabFull1;
    public static final BlockHalfSlab clothSlab2;
    public static final BlockHalfSlab clothSlabFull2;
    public static final Block clothStairs[];

    static
    {
        clothSlab1 = (BlockHalfSlab)(new BlockClothSlab1(137, false)).setHardness(0.8F).setStepSound(soundClothFootstep).setBlockName("clothSlab").setRequiresSelfNotify();
        clothSlabFull1 = (BlockHalfSlab)(new BlockClothSlab1(138, true)).setHardness(0.8F).setStepSound(soundClothFootstep).setBlockName("clothSlab").setRequiresSelfNotify();
        clothSlab2 = (BlockHalfSlab)(new BlockClothSlab2(139, false)).setHardness(0.8F).setStepSound(soundClothFootstep).setBlockName("clothSlab").setRequiresSelfNotify();
        clothSlabFull2 = (BlockHalfSlab)(new BlockClothSlab2(140, true)).setHardness(0.8F).setStepSound(soundClothFootstep).setBlockName("clothSlab").setRequiresSelfNotify();
        String clothStairsName[] =
        {
            "white", "orange", "magenta", "light_blue", "yellow", "light_green",
            "pink", "gray", "light_gray", "cyan", "purple", "blue", "brown",
            "green", "red", "black"
        };
        clothStairs = new BlockStairs[16];

        for (int i = 0; i < 16; i++)
        {
            clothStairs[i] = (new BlockStairs(141 + i, cloth, i)).setBlockName("clothStairs." + clothStairsName[i]).setRequiresSelfNotify();
        }
    }

    public static final Block goldenDoor = (new BlockDoor(157, Material.gold)).setHardness(3F).setStepSound(soundMetalFootstep).setBlockName("godenDoor").disableStats().setRequiresSelfNotify();
    public static final Block ironTrapdoor = (new BlockTrapDoor(158, Material.iron)).setHardness(5F).setStepSound(soundMetalFootstep).setBlockName("ironTrapdoor").disableStats().setRequiresSelfNotify();
    public static final Block stairsglass = (new BlockStairs(159, glass, 0)).setBlockName("stairsglass").setRequiresSelfNotify();

    public static final Block weed = (new BlockWeed(160, 187)).setHardness(0.0F).setStepSound(soundGrassFootstep).setBlockName("weedb").disableStats().setRequiresSelfNotify();
    public static final Block chestargent = (new BlockChestArgent(161)).setHardness(2.5F).setStepSound(soundWoodFootstep).setBlockName("chestargent").setRequiresSelfNotify();
    ...
    static
    {
        ...
        Item.itemsList[clothSlab1.blockID] = (new ItemSlab(clothSlab1.blockID - 256, clothSlab1, clothSlabFull1, false)).setItemName("clothSlab");
        Item.itemsList[clothSlabFull1.blockID] = (new ItemSlab(clothSlabFull1.blockID - 256, clothSlab1, clothSlabFull1, true)).setItemName("clothSlab");
        Item.itemsList[clothSlab2.blockID] = (new ItemSlab(clothSlab2.blockID - 256, clothSlab2, clothSlabFull2, false)).setItemName("clothSlab");
        Item.itemsList[clothSlabFull2.blockID] = (new ItemSlab(clothSlabFull2.blockID - 256, clothSlab2, clothSlabFull2, true)).setItemName("clothSlab");
