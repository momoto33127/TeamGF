...
public abstract class GuiContainer extends GuiScreen
{
    ...
    {
    	//BlockChestArgent blockChestArgent;
        for (int var3 = 0; var3 < this.inventorySlots.inventorySlots.size(); ++var3)
        {
            ...
            {
            	System.out.println("La souris passe sur un item.");
            	//System.out.println(par1 + " - " + par2 + " - " + var3 + " - " + var4 + " -- " + inventorySlots.inventorySlots);
            	/*if(blockChestArgent.blockID)
            	{
            		if()
            		{
