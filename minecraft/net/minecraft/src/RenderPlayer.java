...
public class RenderPlayer extends RenderLiving
{
    ...
    protected void renderEquippedItems(EntityLiving par1EntityLiving, float par2)
    {
        ...
        //ItemStack itemstack = inventoryPlayer.getCurrentItem();
        ...
        EntityPlayerSP playersp = (EntityPlayerSP)par1EntityLiving;
        ItemStack itemstack1 = playersp.getOffHandItem();

        //ItemStack itemstack1 = inventoryPlayer.getCurrentItem1();
        if (itemstack1 != null)
        {
            GL11.glPushMatrix();
