...
public class Item
{
    ...
    public static Item steel = (new Item(133)).setIconCoord(0, 14).setItemName("steel").setTabToDisplayOn(CreativeTabs.tabMaterials);
    public static Item hotIron = (new Item(134)).setIconCoord(1, 14).setItemName("hotIron").setMaxStackSize(16).setTabToDisplayOn(CreativeTabs.tabMaterials);

    public static Item steelPickaxe = (new ItemPickaxe(135, EnumToolMaterial.STEEL)).setItemName("steelPickaxe").setIconCoord(2, 14);
    public static Item steelShovel = (new ItemSpade(136, EnumToolMaterial.STEEL)).setItemName("steelShovel").setIconCoord(3, 14);
    public static Item steelAxe = (new ItemAxe(137, EnumToolMaterial.STEEL)).setItemName("steelAxe").setIconCoord(4, 14);
    public static Item steelHoe = (new ItemHoe(138, EnumToolMaterial.STEEL)).setItemName("steelHoe").setIconCoord(5, 14);

    public static Item steelSword = (new ItemSword(139, EnumToolMaterial.STEEL)).setItemName("steelSword").setIconCoord(6, 14);

    public static Item steelHelmet = (new ItemArmor(140, EnumArmorMaterial.STEEL, 5, 0)).setIconCoord(7, 14).setItemName("steelHelmet");
    public static Item steelPlate = (new ItemArmor(141, EnumArmorMaterial.STEEL, 5, 1)).setIconCoord(8, 14).setItemName("steelPlate");
    public static Item steelLegs = (new ItemArmor(142, EnumArmorMaterial.STEEL, 5, 2)).setIconCoord(9, 14).setItemName("steelLegs");
    public static Item steelBoots = (new ItemArmor(143, EnumArmorMaterial.STEEL, 5, 3)).setIconCoord(10, 14).setItemName("steelBoots");

    public static Item goldenDoor = (new ItemDoor(144, Material.gold)).setIconCoord(11, 14).setItemName("goldenDoor");

    //Biere par momoto
    public static Item chopeEmpty = (new Item(145)).setIconCoord(0, 13).setItemName("chopeEmpty");
    public static Item chopeBeer = (new ItemDrink(146, 10, 1.2F, false)).setAlwaysEdible().setPotionEffect(Potion.confusion.id, 90, 0, 1.0F).setIconCoord(1, 13).setItemName("chopeBeer");

    public static Item weedGraine = (new ItemSeeds(147, Block.weed.blockID, Block.tilledField.blockID)).setIconCoord(3, 13).setItemName("weed.seeds");
    public static Item weed = (new Item(148)).setIconCoord(2, 13).setItemName("weed").setTabToDisplayOn(CreativeTabs.tabMaterials);
    public static Item feuillerouler = (new Item(149)).setIconCoord(5, 13).setItemName("feuille.rouler").setTabToDisplayOn(CreativeTabs.tabMaterials);
    public static Item weedfumable = (new ItemWeed(150, 10, 1.2F, false)).setAlwaysEdible().setPotionEffect(Potion.digSlowdown.id, 90, 0, 1.0F).setPotionEffect(Potion.moveSlowdown.id, 90, 0, 1.0F).setIconCoord(4, 13).setItemName("weed.fumable");
    public static Item megot = (new Item(151)).setIconCoord(6, 13).setItemName("megot");
    
    public static Item piece1 = (new Item(152)).setIconCoord(7, 13).setItemName("piece1").setTabToDisplayOn(CreativeTabs.tabMaterials);
    public static Item piece2 = (new Item(153)).setIconCoord(8, 13).setItemName("piece2").setTabToDisplayOn(CreativeTabs.tabMaterials);
    public static Item billet1 = (new Item(154)).setIconCoord(9, 13).setItemName("billet1").setTabToDisplayOn(CreativeTabs.tabMaterials);
    public static Item billet2 = (new Item(155)).setIconCoord(10, 13).setItemName("billet2").setTabToDisplayOn(CreativeTabs.tabMaterials);
    public static Item billet3 = (new Item(156)).setIconCoord(11, 13).setItemName("billet3").setTabToDisplayOn(CreativeTabs.tabMaterials);
