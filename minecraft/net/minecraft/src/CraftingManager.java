...
public class CraftingManager
{
    ...
    private CraftingManager()
    {
        ...
        this.addRecipe(new ItemStack(Item.chopeEmpty, 1), new Object[]
                {
                    "## ", "###", "## ", '#', Block.wood
                });
        this.addRecipe(new ItemStack(Item.chopeBeer, 1), new Object[]
                {
                    "#X", '#', Item.chopeEmpty, 'X', Item.wheat
                });
        this.addRecipe(new ItemStack(Item.goldenDoor, 1), new Object[]
                {
                    "##", "##", "##", '#', Item.ingotGold
                });
        this.addRecipe(new ItemStack(Block.ironTrapdoor, 2), new Object[]
                {
                    //"#A#", "###", '#', Item.ingotIron, 'A', Item.steel
                    //"###", "###", '#', Item.ingotIron
                    "AAA", "###", "###", '#', Item.ingotIron
                });
        ...
        for (int i = 0; i < 8; i++)
        {
            this.addRecipe(new ItemStack(Block.clothSlab1, 3, i), new Object[]
                    {
        ...
        for (int i = 0; i < 8; i++)
        {
            this.addRecipe(new ItemStack(Block.clothSlab2, 3, i), new Object[]
                    {
                        "###", '#', new ItemStack(Block.cloth, 1, i + 8)
                    });
        }

        for (int i = 0; i < 16; i++)
        {
            this.addRecipe(new ItemStack(Block.clothStairs[i], 4), new Object[]
                    {
                        "#  ", "## ", "###", '#', new ItemStack(Block.cloth, 1, i)
                    });
        }

        this.addRecipe(new ItemStack(Block.stairsglass, 4), new Object[]
                {
                    "#  ", "## ", "###", '#', Block.glass
                });
        this.addRecipe(new ItemStack(Item.steel, 1), new Object[]
                {
                    " X ", "###", '#', Item.hotIron, 'X', Item.coal
                });
        
        this.addRecipe(new ItemStack(Item.feuillerouler, 1), new Object[] {"XXX", "###", "XXX", '#', Block.wood});
       // this.addRecipe(new ItemStack(Item.weedfumable, 1), new Object[] {"XXX", "A#", "XXX", 'A', Item.feuillerouler, '#', new ItemStack(Item.weed, 5)});
        this.addRecipe(new ItemStack(Item.weedfumable, 1), new Object[] {"AAA", "X#X", "AAA", '#', Item.feuillerouler, 'A', Item.weed});
