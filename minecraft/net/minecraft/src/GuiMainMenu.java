...
{
	private String versionMinecraftMod = "v1.0 BETA || 1.3.2";
    ...
    public void initGui()
    {
    	if(debugMod)
    	{
    		System.out.println("Debug mod active.");
    	}
        ...
        else if (var1.get(2) + 1 == 4 && var1.get(5) == 24)
        {
            this.splashText = "Bon anniversaire Momoto33127!";
        }
    ...
    private void func_73969_a(int par1, int par2, StringTranslate par3StringTranslate)
    {
        ...
        this.controlList.add(new GuiButton(70, width / 2 - 100, par1 + par2 * 1, "Connexion Serveur"));
    }
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        if (par1GuiButton.id == 70)
        {
        	if(!debugMod)
        	{
        		mc.displayGuiScreen(new GuiConnecting(mc, "78.248.111.151", 27889));
        	}
        	else
        	{
        		mc.displayGuiScreen(new GuiConnecting(mc, "127.0.0.1", 25565));
        	}
        }
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        GL11.glPopMatrix();
        String var9 = "Geek Fun Client Mod " + versionMinecraftMod;
